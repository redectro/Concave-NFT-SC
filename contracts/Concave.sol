...
contract ConcaveNFT is ERC721Enumerable, Pausable, Ownable {
    ...
    function withdraw() public payable onlyOwner {
        ...
        uint256 for_treasury = (balance * 50) / 100;
        uint256 for_r1 = (balance * 11) / 100; 
        uint256 for_r2 = (balance * 8) / 100;
        uint256 for_r3 = (balance * 8) / 100;
        uint256 for_r4 = (balance * 8) / 100;
        uint256 for_r5 = (balance * 4) / 100;
        uint256 for_r6 = (balance * 5) / 100;
        uint256 for_r7 = (balance * 1) / 100;
        uint256 for_r8 = (balance * 5) / 100;
        ...
        payable(0x9C7f094510161f1B6C39941adE3bC3e53Cfa1Da0).transfer(for_r7);
